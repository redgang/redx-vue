...
export default {
  doBind(){
    ...
    var disabledExpr = element.getAttribute('iscroll-disabled');
    var disabled = false;
    ...
    var distanceExpr = element.getAttribute('iscroll-distance');
    var distance = 0;
    if (distanceExpr) {
    ...
    var immediateCheckExpr = element.getAttribute('iscroll-immediate-check');
    ...
    var eventName = element.getAttribute('iscroll-listen-for-event');
    if (eventName) {
